...
if (choice==1) {
 ...
 input = prompt("Which shape's area do you want to calculate?  1. Triangle 2. Rectangle 3. Parallelogram 4. square 5. Trapezium 6. Rhombus 7. Circle 8. Sector of a circle 9. Ellipse 10. Polygon");
 ...
 height = parseFloat(prompt('Enter the height:'));
 area = base * height;
 document.write('The area of the parallelogram is: '+ area);
 }

 else if (input==4) {
 length = parseFloat(prompt('Enter the length:'));
 area = length**2;
 document.write('The area of the square is: '+ area);
 }
 ...
 height = parseFloat(prompt('Enter the height:'))
 area = 0.5 * (a + b) * height;
 document.write('The area of the trapezium is: '+ area);
 }
  ...
  area = 0.5 * d1 * d2;
  document.write('The area of the rhombus is: '+area);
 }
 ...
 document.write('The area of the circle is: '+ area);
  ...
  document.write('The area of the sector of the circle is: '+ area);
 }
  ...
  area = Math.PI * a * b;
  document.write('The area of the ellipse is: '+ area);
 }
 
 else if (input==10) {
  n = parseFloat(prompt('Enter the number of sides of the polygon:'));
  a = parseFloat(prompt('Enter the length of one side:'));
  area = ((n * a**2) / 4) * (1 / Math.tan(Math.PI / n));
  document.write('The area of the polygon is: '+area);
 }
...
//surface area calculation section
 ...
 input = prompt("Which shape's surface area do you want to calculate?  1. Cube 2. Cuboid 3. Sphere 4. Hemisphere 5. Cylinder 6. Cone 7. Frustum of cone 8. Regular tetrahedron");
 
 if (input==1) {
  a = parseFloat(prompt('Enter the length of one side:'));
  surfaceArea = 6 * a**2;
  document.write('The surface area of the cube is: '+surfaceArea);
 }
  ...
  document.write('The surface area of the cuboid is: '+surfaceArea);
 }
  ...
  document.write('The surface area of the hemisphere is: '+surfaceArea);
 }
  ...
  document.write('The surface area of the cylinder is: '+surfaceArea);
 }
  ...
  document.write('The surface area of the cone is: '+surfaceArea);
 }
  ...
  document.write('The surface area of the Frustum of the cone is: '+surfaceArea);
 }
 
 else if (input==8) {
  a = parseFloat(prompt('Enter the length of one side:'));
  surfaceArea = Math.sqrt(3)*(a**2);
  document.write('The surface area of the regular tetrahedron is: '+surfaceArea);
 }
...
//volume calculation section 
 ...
 input = prompt("Which shape's volume do you want to calculate? 1. Cube 2. Cuboid 3. Cone 4. Cylinder 5. Sphere 6. Hemisphere 7. Prism 8. Pyramid");
 
 if (input==1) {
  length = parseFloat(prompt('Enter the length:'));
  volume = length**3;
  document.write('The volume of the cube is: '+volume);
 }
  ...
  document.write('The volume of the cuboid is: '+volume);
 }
  ...
  document.write('The volume of the cone is: '+volume);
 }
  ...
  document.write('The volume of the cylinder is: '+volume);
  }
   ...
   document.write('The volume of the hemisphere is: '+volume);
  }
   ...
   document.write('The volume of the prism is: '+volume);
  }
   ...
   document.write('The volume of the pyramid is: '+volume);
  }
